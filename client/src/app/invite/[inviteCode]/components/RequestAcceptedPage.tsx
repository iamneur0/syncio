  ...
  return (
    <>
      <div className="text-center mb-8">
        <CheckCircle className="w-16 h-16 mx-auto mb-4" style={{ color: '#3b82f6' }} />
      ...
      <div className="space-y-4">
        <div className="p-4 rounded-lg border" style={{ borderColor: '#3b82f6' }}>
          <p className="text-sm mb-0" style={{ color: 'var(--color-text-secondary)' }}>
            Your request has been accepted. Click the button below to authenticate with Stremio and be added to Syncio.
          </p>
        </div>
